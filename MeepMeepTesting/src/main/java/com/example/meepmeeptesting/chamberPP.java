...
public class chamberPP {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(-62, -8.5, Math.toRadians(180)))
                        .lineToLinearHeading(new Pose2d(-35, 8, Math.toRadians(180)))//
                        .waitSeconds(0)
                        .lineToLinearHeading(new Pose2d(-40, -23, Math.toRadians(-45)))
                        .waitSeconds(0)
                        ...
                        .turn(Math.toRadians(-90))
                        .waitSeconds(0)
                        .lineToLinearHeading(new Pose2d(-40, -45, Math.toRadians(-45)))
                        .waitSeconds(0)
                        .turn(Math.toRadians(-90))//
                        .waitSeconds(0)
                        ...
                        .waitSeconds(0.0)
                        .lineToLinearHeading(new Pose2d(-43, -15, Math.toRadians(180+50)))
                        .waitSeconds(0.0)
