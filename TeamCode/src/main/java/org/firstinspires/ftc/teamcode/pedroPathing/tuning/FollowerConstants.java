...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "dfl";
    public static String leftRearMotorName = "drl";
    public static String rightFrontMotorName = "dfr";
    public static String rightRearMotorName = "drr";
