...
//        .doubleController
//
//    val PID_Power = EnhancedDoubleSupplier{0.0}
//
//    fun holdPose() {
...
//        motorLiftNear.mode = RunMode.STOP_AND_RESET_ENCODER
//        controller.outputConsumer = MotionComponentConsumer { PID_Power}
//    }
//
//    override fun preUserLoopHook(opMode: Wrapper) {
//        BoundBooleanSupplier(EnhancedBooleanSupplier{ PID_Power.state > 0.01 })
//            .onTrue(Lambda("a").setInit{setMotorPower(PID_Power)})
//
//    }
//
//
